...
int main(){
	...
	char pos[2];
	char X,Y,t1,t2;
	int c,i,j,k,m,Score_1=0,Score_2=0;
	menu:
		srand(time(0));
		system("cls");
		int done;
		...
		if(c==2){
			...
			if(Score_1==Score_2)
					cout<<"\n\n\t\t\t Match is Draw";
						...
						cout<<"\n\n\t\t\t\t Player 1 has Won By "<<Score_1-Score_2<<" Congragulations!!!";
					else
			 				cout<<"\n\n\t\t\t\t Player 1 has won by "<<Score_2-Score_1<<" Congragulations!!!";
		...
		// Create a text file
  		...
  		// Write to the file
  		Writescore << p1 <<" "<< Score_1 <<endl;
		Writescore << p2 <<" "<< Score_2 <<endl;	
